...
class OrgIdentityTest extends TestCase
{
    ...
    public function test_no_customer_name_is_left_in_the_source(): void
    {
        ...
        //
        // <b>원청사 이름도 같은 규칙이다.</b> 그물이 우리 회사 이름만 보고 있어서
        // 어떤 원청사 이름이 오래 남아 있었다 — 배지 판독 지시문, 등록 양식의
        // 「그 회사 현장 경험 있나요?」 질문, 그리고 작업자가 서명하는 개인정보
        // 동의문까지. 다른 원청사 현장 작업자에게도 그 질문이 필수로 떴고, 공개
        // 저장소에는 거래처 이름이 그대로 남아 있었다. 원청사는 현장 속성이다
        // (sites.client_company_id) — 코드가 아니라 자료에서 온다.
        $names = ['DASOL', 'NAHSHON', 'HOFFMAN'];
