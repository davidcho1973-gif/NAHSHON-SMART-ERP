                            ...
                            Section::make('팀 / 조직')
                                ...
                                ->schema([
                                    Repeater::make('teams')
                                        ...
                                        ->relationship()
                                        ->schema([
                                            \Filament\Forms\Components\Placeholder::make('qr_code_print')
                                                ->label('출퇴근 QR')
                                                ->content(fn ($record) => $record && $record->code
                                                    ? new \Illuminate\Support\HtmlString("<a href='" . route('team.qr', ['team' => $record]) . "' target='_blank' style='color: #2563eb; font-weight: 700; text-decoration: underline; display: inline-flex; align-items: center; gap: 4px;'><svg style='width: 16px; height: 16px; display: inline;' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z'></path></svg>QR 코드 인쇄/보기</a>")
                                                    : '팀 저장 후 활성화됩니다.'
                                                ),
                                            TextInput::make('code')
                                                ->label('팀 코드')
