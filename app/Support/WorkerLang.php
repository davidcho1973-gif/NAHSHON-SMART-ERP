    ...
    public static function join(): array
    {
        ...
        return [
            'ko' => [
                ...
                'tradeInput' => '선택한 공정 · 직접 입력',
                'tradeOtherPlaceholder' => '예: 공무지원 또는 담당 공정명',
                'tradeLoading' => '선택한 현장의 공정 목록을 불러오는 중입니다.',
                'tradeLoadFailed' => '현장 목록을 불러오지 못했습니다. 아래 칸에 공정명을 직접 입력해 주세요.',
                'email' => '이메일 (선택)',
                ...
                'installApp' => '📲 휴대폰 홈 화면에 추가하기',
                'installHint' => '추가하면 다음부터 QR 없이 아이콘만 눌러 출퇴근합니다.',
            ...
            'en' => [
                ...
                'tradeInput' => 'Selected trade · Edit or type here',
                'tradeOtherPlaceholder' => 'Enter your trade or project support duty',
                'tradeLoading' => 'Loading trades for the selected site.',
                'tradeLoadFailed' => 'Could not load site trades. Type your trade in the field below.',
                ...
                'installApp' => '📲 Add to your phone home screen',
                'installHint' => 'Once added, just tap the icon to clock in — no QR needed.',
            ...
            'es' => [
                ...
                'tradeInput' => 'Oficio seleccionado · Editar o escribir',
                'tradeOtherPlaceholder' => 'Escriba su oficio o función de apoyo',
                'tradeLoading' => 'Cargando los oficios de la obra seleccionada.',
                'tradeLoadFailed' => 'No se pudieron cargar los oficios. Escriba el suyo en el campo de abajo.',
                ...
                'installApp' => '📲 Agregar a la pantalla de inicio',
                'installHint' => 'Una vez agregado, solo toque el ícono para marcar — sin QR.',
