    ...
    public static function join(): array
    {
        return [
            'ko' => [
                ...
                'tradeHint' => '공정관리(WBS)의 공종 목록입니다. 해당 공정이 없으면 현장 관리자에게 문의하세요.',
                'email' => '이메일',
                'phone' => '전화번호',
                'submit' => '작업자로 등록하기',
                'errors' => '입력을 확인해 주세요:',
            ...
            'en' => [
                ...
                'tradeHint' => 'Trades come from the WBS schedule. Ask the site manager if yours is missing.',
                'email' => 'Email',
                'phone' => 'Phone',
            ...
            'es' => [
                ...
                'tradeHint' => 'Los oficios vienen del cronograma (WBS). Consulte al supervisor si no aparece.',
