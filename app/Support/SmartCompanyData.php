...
class SmartCompanyData
{
    ...
    /**
     * 자산 목록(차량·장비·숙소)의 현장 스코프 — <b>그 현장 것만</b>.
     *
     * 예전에는 이 목록들이 상단 현장 전환기를 <b>아예 받지 않아</b>, 애리조나 현장을
     * 띄워 놓고도 조지아 차량·숙소가 함께 떴다. 현장이 하나일 때는 티가 안 났다.
     *
     * 미배정(site_id NULL)도 잠깐 함께 보였으나 사장 결정으로 뺐다. 현장 화면의 숫자는
     * 그 현장의 진실이어야 한다 — 미배정을 섞으면 현장별로 더할 때 겹치고, "우리 현장
     * 차가 몇 대냐" 에 답할 수 없다. 미배정 자산은 '전체 현장' 에서 본다.
     * (재무의 본사 공통은 이와 별개로 ①안 그대로 유지된다.)
     */
    /**
