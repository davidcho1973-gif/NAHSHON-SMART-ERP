...
첨부된 **납품서 / 패킹리스트 / 배송전표 / 인보이스** 를 읽고, 오늘 현장에 도착한
품목과 수량을 한 줄씩 뽑아 주세요. JSON 만 반환합니다.
{$textBlock}
규칙:
- **서류에 실제로 적힌 것만** 뽑습니다. 안 보이면 빈 문자열이나 null 로 두세요.
