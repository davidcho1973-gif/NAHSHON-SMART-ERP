(function () {
  ...
  const exactEn = new Map(Object.entries(bMap({
    ...
    "녹음 내려받기": "Download recording",
    "업로드하고 분석 시작": "Upload and analyze",
    "회의 목록": "Meetings",
    "확인할 사항": "Review needed",
    "반영·조회 결과": "Applied changes and lookup results",
    "수정·대상 선택": "Edit / select target",
    "확인 후 반영": "Review and apply",
    "근거 듣기": "Listen to evidence",
    "반영 취소": "Undo change",
    "실패 단계 재시도": "Retry failed step",
    "다음 회의에서 확인할 미완료 업무": "Open actions for the next meeting",
    "처리 요약": "Processing summary",
    "회의일": "Meeting date",
    "회의 제목": "Meeting title",
    "참석자 · 팀": "Participants / teams",
    "회의 해석 수정": "Edit meeting interpretation",
    "ERP 반영 확인": "Confirm ERP changes",
    "확인하고 반영": "Confirm and apply",
    ...
    '회사 이메일 분석함': 'Company Email AI',
    '회사 이메일 AI 분석함': 'Company Email AI',
  ...
  const exactEs = new Map(Object.entries(bMap({
    ...
    "녹음 내려받기": "Descargar grabación",
    "업로드하고 분석 시작": "Subir y analizar",
    "회의 목록": "Reuniones",
    "확인할 사항": "Revisión pendiente",
    "반영·조회 결과": "Cambios y resultados de consulta",
    "수정·대상 선택": "Editar / seleccionar registro",
    "확인 후 반영": "Revisar y aplicar",
    "근거 듣기": "Escuchar evidencia",
    "반영 취소": "Deshacer cambio",
    "실패 단계 재시도": "Reintentar etapa fallida",
    "다음 회의에서 확인할 미완료 업무": "Acciones abiertas para la próxima reunión",
    "처리 요약": "Resumen del procesamiento",
    "회의일": "Fecha de reunión",
    "회의 제목": "Título de reunión",
    "참석자 · 팀": "Participantes / equipos",
    "회의 해석 수정": "Editar interpretación",
    "ERP 반영 확인": "Confirmar cambios ERP",
    "확인하고 반영": "Confirmar y aplicar",
    ...
    'Company Email AI': 'Correo empresarial con IA',
