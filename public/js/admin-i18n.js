...
(function () {
  ...
  var DICT = Object.assign({
    ...
    '점검필요': { en: 'Needs inspection', es: 'Requiere revisión' },
    '장비 사용 점검': { en: 'Equipment Use Check', es: 'Revisión de uso de equipo' },
    '사용 금지 해제': { en: 'Clear out-of-service', es: 'Liberar fuera de servicio' },
    'QR 스티커 인쇄': { en: 'Print QR stickers', es: 'Imprimir etiquetas QR' },
